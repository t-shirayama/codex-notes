...
| Webアプリ開発スターター | `docs/workflows/web-app-codex-starter.md` | `operations` | [OpenAI Codex Best Practices](https://developers.openai.com/codex/learn/best-practices)<br>[Custom instructions with AGENTS.md](https://developers.openai.com/codex/guides/agents-md) | `2026-05-04` | `checked` | 新規Webアプリ開発前に揃える運用資産とテンプレート例を整理 |
